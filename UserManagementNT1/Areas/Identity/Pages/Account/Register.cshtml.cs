...
namespace UserManagementNT1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            UserManagementNT1Context context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var roleResult = await _roleManager.FindByNameAsync("User");
                    ...
                    if(roleResult !=null)
                    {
                     ...
                     _context.AspNetAuditLog.Add(new Models.AspNetAuditLog { AuditDate = DateTime.Now, Description = "Register Success", Email = user.Email, UserId = userId });
